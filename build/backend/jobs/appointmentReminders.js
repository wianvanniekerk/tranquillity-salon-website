                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: 0 auto; background-color: #f0f9f8; border-radius: 8px; padding: 20px;">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="font-size: 18px; font-weight: bold; margin: 10px 0 0;">Time: ${new Date(appointment.AppointmentDate).toLocaleTimeString('en-GB', { hour: 'numeric', minute: '2-digit' })}</p>
                                                </td>
                                            </tr>
                                        </table>
